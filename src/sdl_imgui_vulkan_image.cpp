...
static uint32_t FindMemoryType(VkPhysicalDevice physicalDevice, uint32_t typeFilter, VkMemoryPropertyFlags properties) {
    ...
    return 0; // Fallback (should handle error properly in production)
}


// Function to create a Vulkan texture from an image file
TextureData CreateTexture(VkDevice device, VkPhysicalDevice physicalDevice, VkCommandPool commandPool, VkQueue queue, const char* imagePath) {
    TextureData texture = {};
...
int main(int argc, char** argv)
{
    ...
    // Initialize Lua with script from argv[1] if provided
